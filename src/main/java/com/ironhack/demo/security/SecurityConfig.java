...
import com.ironhack.demo.security.filters.CustomAuthenticationFilter;
import com.ironhack.demo.security.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                .requestMatchers(HttpMethod.POST, "/accounts").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(HttpMethod.PUT, "/authors").hasAnyAuthority("ROLE_ADMIN")
